...
public class PhotoCmd {
  ...
  @Parameter(names = { "-d","-depth" }, description = "Depth", hidden = false)
...
if (usageMode || cmd == null) {
  ...
  if (cmd != null) p2 = createCmdParser(Collections.singletonMap(cmd, cmdSet.get(cmd)));
